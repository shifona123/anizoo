...
// Securely delete a ticket if requested
if (isset($_GET['delete_id'])) {
    $delete_id = intval($_GET['delete_id']);  // Prevent SQL Injection
    $stmt = $conn->prepare("DELETE FROM foreigner_tickets WHERE id = ?");
    $stmt->bind_param("i", $delete_id);
    if ($stmt->execute()) {
        echo "<script>alert('Foreigner Ticket deleted successfully!'); window.location.href='manage-foreigner-ticket.php';</script>";
    } else {
...
$sql = "SELECT * FROM foreigner_tickets ORDER BY id ASC";
...
<head>
    ...
    <style>
        ...
        .sidebar { width: 250px; background-color: #2C3E50; padding: 15px; color: white; height: 100vh; }
        ...
        .sidebar ul li a.active { background-color: #1ABC9C; }
        .sidebar ul .submenu ul { padding-left: 20px; }
        .sidebar ul .submenu ul li { padding: 5px 10px; }
        .content { flex-grow: 1; padding: 20px; background-color: #ECF0F1; }
...
<div class="container-fluid">
        ...
        <ul>
            ...
            <li class="submenu">Foreigner Ticket
                <ul>
                    ...
                    <li><a href="manage-foreigner-ticket.php" class="active">Manage Ticket</a></li>
                </ul>
            </li>
    ...
    <!-- Content -->
    <div class="content">
        <h2>Manage Foreigner Tickets</h2>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='manage-foreigner-ticket.php?delete_id={$row['id']}' class='btn btn-danger' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                        </td>
                    </tr>";
                    $sn++;
                }
