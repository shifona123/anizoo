...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO normal_tickets (visitor_name, adult_count, child_count) VALUES ('$visitor_name', '$adult_count', '$child_count')";
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li><a href="add-normal-ticket.php" class="active">Add Ticket</a></li>
