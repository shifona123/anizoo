...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $report_type = 'foreigner'; // This page is only for Foreigner Reports

    $sql = "INSERT INTO ticket_reports (report_type, from_date, to_date) VALUES ('$report_type', '$from_date', '$to_date')";
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Foreigner People Report generated successfully!');</script>";
    } else {
...
<head>
    ...
    <title>Foreigner People Report</title>
    <style>
        body {
...
<div class="container-fluid">
        ...
        <ul>
            ...
            <li class="submenu">Reports
                <ul>
                    ...
                    <li><a href="foreigner-people-report.php" class="active">Foreigner People Reports</a></li>
                </ul>
            </li>
    ...
    <div class="content">
        <h2 class="text-primary">Between Dates Reports Of Foreigner Ticket Generating</h2>
        <form method="POST">
