...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT ticket_id, visitor_name, visit_date FROM normal_tickets WHERE ticket_id LIKE '%$search_query%' OR visitor_name LIKE '%$search_query%'";
...
<head>
    ...
    <title>Normal Ticket Search</title>
    <style>
        /* General Styles */
        body {
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="submenu">Search
                <ul>
                    <li><a href="normal-ticket-search.php" class="active">Normal Ticket Search</a></li>
